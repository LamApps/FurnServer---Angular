...
export class CompanyService {
    ...
    enable(id: number, list: any): Observable<any> {
      return this.api.post(`${this.apiController}/enable/${id}`, list);
    }

    permission(id: number, list: any): Observable<any> {
      return this.api.post(`${this.apiController}/permission/${id}`, list);
    }
}